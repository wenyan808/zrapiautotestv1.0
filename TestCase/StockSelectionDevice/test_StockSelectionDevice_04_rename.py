...
@allure.feature('选股器')
class TestStockSelectionDeviceRename:
    @classmethod
    def setup_class(cls) -> None:
        login()

    @allure.story('重命名策略_1-中国香港')
    def test_StockSelectionDevice_rename01(self):
        ...
        # print(_id)
        url = HTTP + "/as_market/api/stock_selector/v1/tactic/rename"
        headers = JSON
