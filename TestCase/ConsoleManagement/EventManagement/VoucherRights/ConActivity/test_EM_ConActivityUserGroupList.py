# test_EM_ConActivityUserGroupList   活动用户组详情列表(二期)   /api/con_activity/v1/user_group_list
import json
import logging
import random
...
class TestEMConActivityUserGroupList():
    @classmethod
    ...
    @pytest.mark.parametrize('info',
                             get_json(
                                 BASE_DIR + r"/TestData/test_EventManagementdata/test_EM_ConActivityUserGroupList.json"))
    def test_EM_ConActivityUserGroupList(self, info):
