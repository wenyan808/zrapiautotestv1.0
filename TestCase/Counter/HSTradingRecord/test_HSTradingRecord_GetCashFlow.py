# test_HSTradingRecord_GetCashFlow     交易流水           /as_trade/api/cash_flow/v1/get_cash_flow
import json
...
class TestHSTradingRecordGetCashFlow():
    ...
    @pytest.mark.parametrize('info',
                             get_json(BASE_DIR +
                                      ...
                                      r"test_HSTradingRecord_GetCashFlowdata.json"))
    def test_HSTradingRecord_GetCashFlow(self, info):
        ...
        url = http + "/as_trade/api/cash_flow/v1/get_cash_flow"
        ...
        r = Requests(self.session).post(
            url=url, headers=headers, data=payload2, title="交易流水"
        )
