# test_RStrategy_StrategyDetai     组合详情     /as_trade/api/strategy/v1/strategy_detail
import json
...
class TestRStrategyStrategyDetai():
    ...
    def test_RStrategy_StrategyDetai(self):
        ...
        url1 = http + "/as_trade/api/strategy/v1/strategy_detail"
        # 拼装参数
        headers = JSON_dev
        headers = headers
        headers1 = {}
        ...
        r = Requests(self.session).post(
            url=url1, headers=headers1, data=payload3, title="组合详情"
        )
