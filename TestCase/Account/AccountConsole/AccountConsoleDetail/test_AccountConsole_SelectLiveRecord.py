# test_AccountConsole_SelectLiveRecord       人脸活体验证记录      /api/con_open/v1/select_live_record
import json
...
@allure.feature('开户console_人脸活体验证记录')
class TestAccountConsoleSelectCardRecord():
    ...
    def test_AccountConsole_SelectLiveRecord(self):
        url = console_HTTP + "/api/con_open/v1/select_live_record"
        ...
        r = Requests(self.session).post(
            url=url, headers=headers, data=payload, title="人脸活体验证记录"
        )
