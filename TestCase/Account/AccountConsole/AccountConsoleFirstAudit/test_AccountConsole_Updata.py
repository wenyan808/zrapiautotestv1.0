# test_AccountConsole_Updata       修改信息         /api/con_open/v1/update
import json
...
@allure.feature('开户console_修改信息')
class TestAccountConsoleUpdata():
    @classmethod
    ...
    # @pytest.mark.skip(reason="调试中 ")
    def test_AccountConsole_Updata(self):
        url1 = console_HTTP + "/api/con_open/v1/update"
        ...
        r1 = Requests(self.session).post(
            url=url1, headers=headers, data=payload, title="修改信息"
        )
