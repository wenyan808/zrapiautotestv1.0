# test_HSAccountAnalysis_IpoAnalysisProfit    新股盈亏分析     /as_trade/api/ipo_analysis/v1/profit
import json
...
@allure.feature('柜台app_新股盈亏分析')
class TestHSAccountAnalysisIpoAnalysisProfit():
    @classmethod
    ...
    def test_HSAccountAnalysis_IpoAnalysisProfit(self):
        ...
        r_info = Requests(self.session).post(
            url=url, headers=headers, data=payload2, title="新股盈亏分析"
        )
