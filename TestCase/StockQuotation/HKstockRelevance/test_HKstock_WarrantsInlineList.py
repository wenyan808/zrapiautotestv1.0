# test_HKstock_WarrantsInlineList   全部轮证-界内证列表    /as_market/api/hk/warrants/v1/inline_list
import json
...
@allure.feature('港股_全部轮证-界内证列表')
class TestHKstockWarrantsInlineList():
    @classmethod
    ...
    # @pytest.mark.skip(reason="调试中 ")
    @pytest.mark.parametrize('info', get_json(BASE_DIR + r"/TestData/HKstockData/test_HKstock_WarrantsInlineList.json"))
    def test_HKstock_WarrantsInlineList(self,info):
